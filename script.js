...
var iconEl1 = document.querySelector("#ic1");
...
var iconEl2 = document.querySelector("#ic2");
...
var iconEl3 = document.querySelector("#ic3");
...
var iconEl4 = document.querySelector("#ic4");
...
var iconEl5 = document.querySelector("#ic5");
...
function getFetch(lat, lon) {
    ...
    fetch(weatherUrl).then(function (response) {
        ...
        var iconU =  "https://openweathermap.org/img/w/" + iconId + ".png";
        iconEl.setAttribute("src", iconU);
...
//This is for the 5 day forcast
    fetch(requestUrl).then(function (response) {
        ...
        var iconId1 = data.list[3].weather[0].icon;
        var iconU1 =  "https://openweathermap.org/img/w/" + iconId1 + ".png";
        iconEl1.setAttribute("src", iconU1);
        ...
        var iconId2 = data.list[11].weather[0].icon;
        var iconU2 =  "https://openweathermap.org/img/w/" + iconId2 + ".png";
        iconEl2.setAttribute("src", iconU2);
        ...
        var iconId3 = data.list[19].weather[0].icon;
        var iconU3 =  "https://openweathermap.org/img/w/" + iconId3 + ".png";
        iconEl3.setAttribute("src", iconU3);
        ...
        var iconId4 = data.list[27].weather[0].icon;
        var iconU4 =  "https://openweathermap.org/img/w/" + iconId4 + ".png";
        iconEl4.setAttribute("src", iconU4);
        ...
        var iconId5 = data.list[35].weather[0].icon;
        var iconU5 =  "https://openweathermap.org/img/w/" + iconId5 + ".png";
        iconEl5.setAttribute("src", iconU5);
